...
import com.wangpos.s_mvp.ui.asynctask.AsyncImagePresenter;
...
public class DisplayPhotoAdapter extends RecyclerView.Adapter<DisplayPhotoAdapter.ViewHolder> implements SyncTaskContract.View {
    ...
    AsyncImagePresenter presenter;

    public DisplayPhotoAdapter(List<Integer> aImageUrls, Context ctx){
        this.imageUrls = aImageUrls;
        this.context = ctx;
        presenter = new AsyncImagePresenter();
    }
